...
[Your Name]`;
  ...
  if (!project) {
    return (
      <>
        <Helmet>
          <title>{project ? `${project.title} | Project | Muhammad Safdar Iqbal` : 'Project Not Found | Muhammad Safdar Iqbal'}</title>
          <meta name="description" content={project ? project.description : 'Project not found.'} />
          <meta name="keywords" content={project ? `${project.title}, project, enterprise software, technology, Pakistan` : 'project not found'} />
          <meta name="robots" content={project ? 'index, follow' : 'noindex'} />
          <link rel="canonical" href={`https://your-portfolio-domain.com/project/${id}`} />
          <meta property="og:title" content={project ? `${project.title} | Project | Muhammad Safdar Iqbal` : 'Project Not Found | Muhammad Safdar Iqbal'} />
          <meta property="og:description" content={project ? project.description : 'Project not found.'} />
          <meta property="og:type" content="article" />
          <meta property="og:url" content={`https://your-portfolio-domain.com/project/${id}`} />
          {project && <meta property="og:image" content={project.image} />}
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content={project ? `${project.title} | Project | Muhammad Safdar Iqbal` : 'Project Not Found | Muhammad Safdar Iqbal'} />
          <meta name="twitter:description" content={project ? project.description : 'Project not found.'} />
          {project && <meta name="twitter:image" content={project.image} />}
          ...
          {project && (
            <script type="application/ld+json">{JSON.stringify({
              ...
              'mainEntityOfPage': {
                '@type': 'WebPage',
                '@id': `https://your-portfolio-domain.com/project/${id}`
              }
            })}</script>
          )}
        </Helmet>
