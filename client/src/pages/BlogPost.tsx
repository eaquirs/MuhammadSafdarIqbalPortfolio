...
export default function BlogPost() {
  ...
  if (!post) {
    return (
      <div className="min-h-screen bg-white dark:bg-slate-900 flex items-center justify-center">
        <Helmet>
          <title>Article Not Found | Muhammad Safdar Iqbal</title>
  ...
  return (
    <>
      <Helmet>
        <title>{post.seo.metaTitle || post.title} | Blog | Muhammad Safdar Iqbal</title>
        <meta name="description" content={post.seo.metaDescription || post.excerpt} />
        <meta name="keywords" content={post.seo.keywords || post.title + ', blog, enterprise software, technology, Pakistan'} />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`https://your-portfolio-domain.com/blog/${post.slug}`} />
        ...
        <meta property="og:url" content={`https://your-portfolio-domain.com/blog/${post.slug}`} />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          'author': {
            '@type': 'Person',
            'name': post.author?.name || 'Muhammad Safdar Iqbal',
          ...
          'mainEntityOfPage': {
            '@type': 'WebPage',
            '@id': `https://your-portfolio-domain.com/blog/${post.slug}`
          }
        })}</script>
      </Helmet>
